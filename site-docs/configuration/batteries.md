...
If you raise a battery's **Max SOC** to `100 %`, that battery uses voltage-based top protection: 100 W charge throttle from 3.45 V, a 3.55 V balance measurement, and a final 25 W discharge to 3.42 V. See [Cell balance monitor](../features/cell-balance-monitor.md#active-top-balancing-profile) for the exact entry and exit conditions.
